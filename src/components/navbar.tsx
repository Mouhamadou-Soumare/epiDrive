    ...
    <header className="relative isolate z-10 ">
       <div aria-label="Top">
          ...
          <div className="bg-gray-900">
            ...
            <div className="flex items-center gap-4"><p className="flex-1 text-base text-sm  a-primary font-bold lg:flex-none">
              5€ offerts dès 50€ d'achat avec le code FIRST
                            </p> <TicketIcon className="max-w-6 ticket-svg-top-nav"/> </div>
    ...
    <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-4  xl:gap-x-8">
      {maisonLoisirs.map((category) => (
        ...
        >
          ...
          <a href="/snap-and-cook" className="flex items-center gap-2 px-4 py-2.5  text-dark rounded-lg transition-colors duration-200 min-w-40 text-nav-hover">
          <svg className="max-w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M13 26H7.16A1.16 1.16 0 0 1 6 24.84V19a1 1 0 0 0-2 0v5.84A3.17 3.17 0 0 0 7.16 28H13a1 1 0 0 0 0-2zM27 18a1 1 0 0 0-1 1v5.84A1.16 1.16 0 0 1 24.84 26H19a1 1 0 0 0 0 2h5.84A3.17 3.17 0 0 0 28 24.84V19a1 1 0 0 0-1-1zM19 6h5.84A1.16 1.16 0 0 1 26 7.16V13a1 1 0 0 0 2 0V7.16A3.17 3.17 0 0 0 24.84 4H19a1 1 0 0 0 0 2zM5 14a1 1 0 0 0 1-1V7.16A1.16 1.16 0 0 1 7.16 6H13a1 1 0 0 0 0-2H7.16A3.17 3.17 0 0 0 4 7.16V13a1 1 0 0 0 1 1z"/><path d="M23 14a1 1 0 0 0 1-1v-1.84A3.17 3.17 0 0 0 20.84 8h-9.68A3.17 3.17 0 0 0 8 11.16V13a1 1 0 0 0 2 0v-1.84A1.16 1.16 0 0 1 11.16 10h9.68A1.16 1.16 0 0 1 22 11.16V13a1 1 0 0 0 1 1zM9 18a1 1 0 0 0-1 1v1.84A3.17 3.17 0 0 0 11.16 24h9.68A3.17 3.17 0 0 0 24 20.84V19a1 1 0 0 0-2 0v1.84A1.16 1.16 0 0 1 20.84 22h-9.68A1.16 1.16 0 0 1 10 20.84V19a1 1 0 0 0-1-1zM29 15H3a1 1 0 0 0 0 2h26a1 1 0 0 0 0-2z"/></svg>
