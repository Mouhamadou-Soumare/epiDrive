...
export default function SearchResultsPage() {
  ...
  const sortedAndFilteredProducts = products
    .filter(
      (product) =>
        ...
        selectedCategories.includes(product.categorieSlug)
    )
    .sort((a, b) => {
  ...
  if (products.length === 0)
    return <div>Aucun produit trouvé pour la recherche "{query}"</div>;
      ...
      <div>
                    ...
                    <div className="space-y-4">
                      {categories.map((category) => (
                        <div key={category.id} className="flex items-center">
                          ...
                          />
                          <label
                            htmlFor={`category-${category.slug}-mobile`}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="border-b border-gray-200 pb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-2 mt-8">
                ...
                {displayedProducts.map((product) => (
                  ...
                  >
                    <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                      <img
                        src={
                          product.imageSrc || "https://via.placeholder.com/300"
                        }
