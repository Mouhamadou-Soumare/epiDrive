  ...
  const faqs = [
    {
      id: 1,
      question:
        "Comment fonctionne la reconnaissance d'ingrédients sur EpiDrive ?",
      answer:
  ...
  const features = [
    {
      name: "Snap & Cook",
      description:
        "Scannez vos plats, l'IA identifie les ingrédients et les ajoute automatiquement à votre liste de courses.",
      icon: CloudArrowUpIcon,
    },
    {
      name: "Livraison Rapide",
      description:
        "Choisissez entre livraison à domicile ou retrait en drive avec des délais de livraison rapides et garantis.",
      icon: LockClosedIcon,
    },
    {
      name: "Recommandations Personnalisées",
      description:
        "Profitez de suggestions de produits basées sur vos habitudes d'achats et préférences alimentaires.",
      icon: ArrowPathIcon,
    },
    {
      name: "Paiements Sécurisés",
      description:
        "Des solutions de paiement rapides et sécurisées avec plusieurs options (carte, PayPal, etc.).",
    ...
    },
    {
      ...
      description:
        "Restez informé de chaque étape, de la préparation à la livraison de vos courses.",
      icon: ServerIcon,
    },
  ];
  return (
    <div className="min-h-screen">
      <main>
            ...
            <div className="relative overflow-hidden rounded-lg">
              ...
              <div className="relative bg-red-700/75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
                <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                  ...
                  >
                    Partagez l’amour autour de vous
                  </h3>
                  <p className="mt-3 text-xl text-white">
                    En achetant nos produits solidaires, vous contribuez à
                    offrir un repas ou un cadeau à ceux qui en ont besoin.
                  </p>
                  <a
                    href="#"
                    className="mt-8 block w-full rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100 sm:w-auto"
                  >
                    En savoir plus et offrir
                  </a>
                </div>
              </div>
            </div>
        ...
        <section className="button-secondary py-16 text-white text-center">
          ...
          <p className="mb-8">
            Livraison rapide, produits frais et une expérience d'achat en ligne
            exceptionnelle.
          </p>
          <a
            href="/shop"
